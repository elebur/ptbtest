...
ERR_MSG = re.escape("Can't parse entities: can't find end "
...
class TestBold:
    ...
    def test_escaped_symbol_inside_entity(self):
        with pytest.raises(BadMarkupException, match=ERR_MSG.format(offset=21)):
    ...
    def test_unclosed_entity(self):
        with pytest.raises(BadMarkupException, match=ERR_MSG.format(offset=5)):
