...
class Testtimerbot(unittest.TestCase):
    ...
    def test_timer(self):
        ...
        def set_alarm(update, args, job_queue, chat_data):
        ...
        def unset_alarm(update, chat_data):
        ...
        dp.add_handler(CommandHandler("set", set_alarm, pass_args=True, pass_job_queue=True, pass_chat_data=True))
